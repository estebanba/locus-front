    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-svh w-full relative overflow-hidden",
            className
          )}
          {...props}
        >
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="absolute right-3 top-[0.625rem]">
            <Button
              variant="ghost"
              size="icon"
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-background flex flex-1 flex-col transition-[margin] duration-200 ease-linear",
        "w-full md:group-data-[side=right]:peer-data-[state=expanded]:mr-64",
